...
function Pricing() {
  return (
    <section className="pricing-section container mx-auto mt-32">
      <div className="pricing-section__content-wrapper bg-[#171717]  flex flex-col md:flex-row items-center justify-between px-12 rounded-3xl">
        ...
        <div className="pricing-section-right__content w-full -translate-y-[8rem] md:translate-0 text-center md:text-start md:w-[50%]">
          <h2 className="pricing-section-right__content-title text-[28px] sm:text-[40px] md:text-[28px] lg:text-[40px] 2xl:text-[50px] font-sans">
