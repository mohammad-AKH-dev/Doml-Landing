...
function Companies() {
  const [companies, setCompanies] = useState([
    ...
    { id: 5, title: "cocacola", path: "/images/companies/Coca Cola.png" },
    {
      ...
      path: "/images/companies/Creative Cloud.png",
    },
    {
      id: 7,
      title: "dangote",
      path: "/images/companies/Dangote.png",
      darkPath: "/images/companies/dark-dangote.png",
    },
    ...
    { id: 10, title: "Facebook", path: "/images/companies/Facebook.png" },
    {
      id: 11,
      title: "FirstBank",
      path: "/images/companies/FirstBank.png",
      darkPath: "/images/companies/dark-firstbank.png",
    },
    ...
    { id: 13, title: "mtn", path: "/images/companies/mtn.png" },
    {
      id: 14,
      title: "paga",
      path: "/images/companies/paga.png",
      darkPath: "/images/companies/dark-paga.png",
    },
